...
import 'package:ecommerce_app_with_firebase/controllers/chats_controller.dart';
import 'package:ecommerce_app_with_firebase/services/firestore_services.dart';
import 'package:ecommerce_app_with_firebase/views/chat_screen/components/sender_bubble.dart';
                      ...
                      child: StreamBuilder(
                          ...
                          builder: (BuildContext context,
                            ...
                            if (!snapshot.hasData) {
                              ...
                              return Center(
                                child:
                                    "Have you any query related to this product!!..."
                                        .text
                                        .color(darkFontGrey)
                                        .make(),
                              );
